...
# Created by:  Kushal
#
# Description: Marques Brownlee Twitter Bot - https://github.com/KushalChi/TwitterViralityResearchProject
#
...
id = 1347965583480991745 #Sample Tweet from Marques Brownlee's Twitter Account": @MKBHD
...
file = "Enter your file path to where TwitterMarquesBrownlee.csv is located here" 
    
with open(file, mode='a') as employee_file: #Opens the TwitterMarquesBrownlee.csv file and writes the data to it
