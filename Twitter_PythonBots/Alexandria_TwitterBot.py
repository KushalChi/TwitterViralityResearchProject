...
# Created by:  Kushal
#
# Description: Alexandria Twitter Bot - https://github.com/KushalChi/TwitterViralityResearchProject
#
...
id = 1347978647454576642 #Sample Tweet from Alexandria Ocasio-Cortez' Twitter Account": @AOC
...
file = "Enter your file path to where TwitterAlexandria.csv is located here" 
    
with open(file, mode='a') as employee_file: #Opens the TwitterAlexandria.csv file and writes the data to it
