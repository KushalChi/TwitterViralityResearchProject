...
# Created by:  Kushal
#
# Description: Basketball Twitter Bot - https://github.com/KushalChi/TwitterViralityResearchProject
#
...
id = 1347976583944962048 #Sample Tweet from Bleacher Report Basketball news Twitter Account": @BleacherReport
...
file = "Enter your file path to where TwitterBasketball.csv is located here" 
    
with open(file, mode='a') as employee_file: #Opens the TwitterBasketball.csv file and writes the data to it
