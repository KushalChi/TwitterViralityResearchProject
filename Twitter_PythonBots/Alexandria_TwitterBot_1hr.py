...
# Created by:  Kushal
#
# Description: Alexandria Twitter Bot 1 HOUR - https://github.com/KushalChi/TwitterViralityResearchProject
#
...
id = 1362511295682117641 #Sample Tweet from Alexandria Ocasio-Cortez' Twitter Account": @AOC
...
file = "Enter your file path to where alexandria_1hr.csv is located here" 
    
with open(file, mode='a') as employee_file: #Opens the alexandria_1hr.csv file and writes the data to it
