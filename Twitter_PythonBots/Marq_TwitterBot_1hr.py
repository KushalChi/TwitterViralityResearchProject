...
# Created by:  Kushal
#
# Description: Marques Brownlee Twitter Bot 1 HOUR - https://github.com/KushalChi/TwitterViralityResearchProject
#
...
id = 1360640497002381313 #Sample Tweet from Marques Brownlee's Twitter Account": @MKBHD
...
file = "Enter your file path to where marq_1hr.csv is located here" 
    
with open(file, mode='a') as employee_file: #Opens the marq_1hr.csv file and writes the data to it
